...
class Solution {
    public TreeNode bstFromPreorder(int[] preorder) {
        ...
        //iterate along the elements of preorder array
        for (int i = 1; i < n; i++){
            // take the last element of the deque as a parent and create a child 
            // from the next preorder element
