...
public class Solution {
    public String[] findNearestCities(int numOfPoints, String[] points,
            int[] xCoordinates, int[] yCoordinates, int numOfQueriedPoints, String[] queriedPoints) {
        ...
        // 遍历所有城市，把对应城市添加入xMap和yMap（某坐标对应的城市TreeSet有序排列）
